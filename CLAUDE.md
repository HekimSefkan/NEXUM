...
- **Profil paneli yerleşimi:** İstatistik kartları 430×600 (kaynak görsel oranına yakın), kartlar arası boşluk 24, grup 884 genişlikte ve ortalanmış (Content VerticalLayoutGroup hizası UpperCenter). Değer metinleri font 64, başlıklar font 40 ve 400×85. İçerik 2800 birim olduğu için 1080×1920'de kaydırma gereklidir (897 birim taşar).
